...
function TasksTable({
  ...
  return (
    <div className="overflow-hidden rounded-[20px] border border-white/[0.08] bg-[#171717]">
      ...
      <div
        className={cn(
          TABLE_GRID,
          'border-y border-white/[0.07] px-4 py-2 font-mono text-[10.5px] tracking-wide text-[#5b6068] uppercase'
        )}
      >
        <span>id</span>
        <span>title</span>
      ...
      {status ? (
        <p className="px-4 py-3 text-sm text-destructive" role="status">
          {status}
        </p>
      ) : null}
    </div>
